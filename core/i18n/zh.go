...
var zhStrings = map[string]string{
	...
	"help.mech.power.3":  "  结算时现金为 0：60 秒断电 —— 全部停产。",
	"help.mech.power.act": "  → 盯紧主面板的「净」值，负号就是亏损。",
	"help.mech.earn":     "\uf201 收益 —— 显卡每 tick 产 BTC，自动卖成现金。",
	...
	"log.legacy.cash":       "Legacy 奖励：启动资金 +$%.0f。",
