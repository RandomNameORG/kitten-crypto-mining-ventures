...
var enStrings = map[string]string{
	...
	"dash.power.deficit":   "losing $/s — cash lasts %s",
	...
	"help.mech.power.3":  "  If money hits $0 mid-bill: 60-second blackout — no earnings.",
	"help.mech.power.act": "  → watch \"net\" on the dashboard. Negative = bleeding.",
	"help.mech.earn":     "\uf201 Earnings — GPUs mint BTC per tick; it auto-sells to cash.",
	...
	"log.event.gift.sold":      "…but no room. Sold %s for cash.",
	...
	"log.event.fire.money":     "\uf155 Lost $%.0f (%.0f%% of cash).",
	...
	"log.legacy.cash":       "Legacy bonus: +$%.0f starter cash.",
