...
func main() {
	...
	mux.Handle("/ui2d/", http.StripPrefix("/ui2d/", http.FileServer(http.Dir("ui2d"))))
...
func serveIndex(w http.ResponseWriter, r *http.Request) {
	...
	http.ServeFile(w, r, filepath.Join("ui2d", "play.html"))
}
...
func init() {
	if wd, err := os.Getwd(); err == nil {
		if _, err := os.Stat(filepath.Join(wd, "ui2d")); err != nil {
			log.Printf("warning: run from repository root so ui2d/ and assets/ are available")
		}
	}
}
